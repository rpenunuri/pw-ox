...
```
BASE_URL=http://www.openx.com BROWSER=chromium GROUP=@smoke docker-compose up --build
```
...
- `-u|--url`: The base URL used for all of the test cases. If not provided, `http://www.openx.com` is used.
